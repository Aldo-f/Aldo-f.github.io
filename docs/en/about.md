...
documentation from several repositories at build time — each section is pulled
live from its source repo when this site builds, so it always matches the code.
