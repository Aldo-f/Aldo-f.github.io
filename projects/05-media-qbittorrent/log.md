---
type: Log
title: qBittorrent BitTorrent Client Change Log
description: Chronological log of changes to the qBittorrent documentation
resource: ./05-media-qbittorrent/log.md
tags: [changelog, qbittorrent, media]
sources:
